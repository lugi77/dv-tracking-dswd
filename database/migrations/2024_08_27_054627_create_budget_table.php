...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('budget', function (Blueprint $table) {
            $table->id();
            $table->integer('dvNum', 10); // DV No. with a max length of 10 characters
            ...
            $table->string('budget_controller', 75); // Controller with a max length of 75 characters
            $table->decimal('gross_amount', 15, 2); // Gross Amount as a decimal with precision 15 and scale 2
            $table->varchar('final_amount_norsa', 15, 2); // Final Amount NORSA as a decimal with precision 15 and scale 2
