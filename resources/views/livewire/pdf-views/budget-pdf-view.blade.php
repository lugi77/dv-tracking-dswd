    ...
    <div class="container">
        <div class="processed">
            ...
            <table>
                ...
                <tbody>
                    @foreach($processedProgram as $data)
                        <tr>
                            <td>{{  $data->program }}</td>
                    ...
                    <tr class="total-row">
                        <td>Total</td>
                        <td>{{ $processedProgram->sum('total_processed_dvs') ?? 0 }}</td>
                        <td>{{ number_format($processedProgram->sum('total_processed_amount') ?? 0, 2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="unprocessed">
            ...
            <table>
                ...
                <tbody>
                    @foreach($unprocessedProgram as $data)
                        <tr>
                            <td>{{  $data->program }}</td>
                    ...
                    <tr class="total-row">
                        <td>Total</td>
                        <td>{{ $unprocessedProgram->sum('total_unprocessed_dvs')}}</td>
                        <td>{{ number_format($unprocessedProgram->sum('total_unprocessed_amount'),2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
