<div class="container mx-auto">
    ...
    <div class="flex justify-around mb-4">
        <div class="bg-white p-4 border rounded shadow text-center w-1/3">
            ...
            <h2 class="text-xl font-bold">{{ number_format($totalDvCount) }}</h2>
        </div>
        <div class="bg-white p-4 border rounded shadow text-center w-1/3">
            <p class="font-semibold">Total Number of Unprocessed DVs</p>
            <h2 class="text-xl font-bold">{{ number_format($totalUnprocessedCount) }}</h2>
        </div>
        <div class="bg-white p-4 border rounded shadow text-center w-1/3">
            <p class="font-semibold">Total Net Amount</p>
            <h2 class="text-xl font-bold">₱{{ number_format($totalAmount, 2) }}</h2>
        </div>
    </div>
